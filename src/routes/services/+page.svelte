...
<SEO
	...
	description="Dental services in Istanbul: check-ups, teeth whitening, Invisalign, fillings, implants & emergency care. Transparent pricing, honest advice."
	canonical="/services"
/>
...
<PageShell>
	...
	<Section tone="surface" spacing="spacious" class="scroll-fade-in">
		...
		<div class="mb-8 flex flex-wrap gap-2" role="tablist" aria-label="Service categories">
			{#each categories as cat (cat.value)}
				<button
					...
					class="rounded-full px-5 py-2.5 text-sm font-medium transition-all duration-200 {activeCategory ===
					cat.value
		...
		<div class="grid gap-6 md:grid-cols-2">
			{#each filteredServices as service (service.name)}
				...
				<article
					class="group relative rounded-2xl bg-gradient-to-b from-neutral-100 to-white p-[1px] shadow-md transition-all duration-300 {isExpanded
						? 'shadow-lg ring-2 ring-primary-500'
						: 'hover:-translate-y-1 hover:from-primary-100 hover:shadow-xl hover:shadow-neutral-900/10'}"
				>
					<div class="h-full overflow-hidden rounded-2xl bg-white">
						<div class="p-6 sm:p-8">
							...
							<div class="flex items-start gap-4">
								<!-- Icon -->
								<div
									class="grid h-12 w-12 flex-shrink-0 place-items-center rounded-xl bg-primary-50 text-primary-600 transition-colors group-hover:bg-primary-100"
								>
								...
								<div class="min-w-0 flex-1">
									<div class="flex items-start justify-between gap-2">
										...
										<span class="flex-shrink-0 text-lg font-semibold text-neutral-900"
											>{service.price}</span
										>
									</div>
									<span
										class="mt-1 inline-block rounded-full px-2.5 py-0.5 text-xs font-medium {getCategoryStyle(
											service.category
										)}"
									>
						...
						<div class="border-t border-neutral-100">
							<button
								...
								class="flex w-full items-center justify-between px-6 py-4 text-sm font-medium text-neutral-500 transition-colors hover:bg-neutral-50 hover:text-neutral-900 sm:px-8"
							>
							...
							{#if isExpanded}
								<div class="animate-fadeIn space-y-5 px-6 pb-6 sm:px-8 sm:pb-8">
									<div>
										<h4 class="mb-3 text-xs font-semibold tracking-wide text-neutral-900 uppercase">
											What's Included
										</h4>
										<ul class="space-y-2">
											{#each service.includes as item (item)}
												<li class="flex items-start gap-3 text-sm text-neutral-600">
													<svg
														class="mt-0.5 h-5 w-5 flex-shrink-0 text-sage-500"
														fill="none"
														stroke="currentColor"
														stroke-width="2"
														viewBox="0 0 24 24"
									...
									<div>
										<h4 class="mb-2 text-xs font-semibold tracking-wide text-neutral-900 uppercase">
											Ideal For
										</h4>
			...
			<div class="flex items-start gap-4">
				...
				<div>
					...
					<p class="mt-1 text-neutral-600">
						Describe your symptoms or concerns and we'll guide you to the right treatment — no
						pressure.
					</p>
				</div>
			</div>
	...
	<Section tone="surface" spacing="default" class="scroll-fade-in">
		<div class="grid gap-6 sm:grid-cols-3">
			<div
				class="flex items-start gap-4 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-neutral-900/5"
			>
				<div
					class="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-sage-100 text-sage-600"
				>
					<svg
						class="h-5 w-5"
						fill="none"
				...
				<div>
					...
					<p class="mt-1 text-sm text-neutral-500">
						Interest-free installments for treatments over ₺5,000
					</p>
				</div>
			</div>
			<div
			...
			>
				<div
					class="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-amber-100 text-amber-600"
				>
					<svg
						class="h-5 w-5"
						fill="none"
