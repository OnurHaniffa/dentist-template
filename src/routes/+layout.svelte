...
<!-- JSON-LD structured data for search engines (LocalBusiness schema) -->
<LocalBusinessSchema />
...
<div class="min-h-screen bg-white text-neutral-900 antialiased">
	...
	<a
		...
		class="group fixed right-6 bottom-6 z-50 flex items-center gap-3 rounded-full bg-[#25D366] px-5 py-3.5 font-semibold text-white shadow-lg shadow-[#25D366]/30 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-[#25D366]/40"
