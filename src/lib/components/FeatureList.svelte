...
<ul class={listClasses}>
  {#each items as item}
    <li class={itemClasses}>
      {#if icon === "check"}
        <svg class={iconClasses} aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
          <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" />
        </svg>
      {:else if icon === "arrow"}
        <svg class={iconClasses} aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
